...
import com.android.tv.tuner.databinding.UtChannelListBinding;
...
public class ScanFragment extends SetupFragment {
    ...
    private static final boolean FAKE_MODE = true;
    ...
    private static class ChannelAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                UtChannelListBinding binding = DataBindingUtil.inflate(inflater,
                        R.layout.ut_channel_list, parent, false);
                binding.setChannel(mChannels.get(position));
